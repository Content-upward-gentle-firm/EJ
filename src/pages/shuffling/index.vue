 ...
 * @Version: 1.0
 * @Autor: xuxu
 * @Date: 2021-09-06 15:10:59
 * @LastEditors: xuxu
 * @LastEditTime: 2021-09-06 15:10:59
-->
<template>
  <div class="production">
    ...
    <div class="table">
        ...
        <el-table-column prop="introduce" label="轮播图名称"> </el-table-column>
        <el-table-column prop="icon" label="轮播图图片">
...
export default {
    ...
    methods: {
        ...
        let res = await request.get("/carousel/findAll", {
        ...
        delHandler(id){
            this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                ...
                // 这里得有属性名 id : id
                request.get("/carousel/deleteById",{params:{id}}).then((res) =>{
        ...
        this.$refs["saveForm"].validate((valid) => {
            if (valid) {
            request
                .post("/carousel/saveOrUpdate", qs.stringify(this.production))
                .then((res) => {
